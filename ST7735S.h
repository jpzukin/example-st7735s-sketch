...
#define   ST7735S_RED       (0b0000000000011111)
#define   ST7735S_GREEN     (0b0000011111100000)
#define   ST7735S_BLUE      (0b1111100000000000)
#define   ST7735S_YELLOW    (0b0000011111111111)
#define   ST7735S_PURPLE    (0b1111100000011111)
#define   ST7735S_AQUA      (0b1111111111100000)
